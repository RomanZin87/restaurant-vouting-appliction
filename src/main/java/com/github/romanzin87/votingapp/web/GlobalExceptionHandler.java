package com.github.romanzin87.votingapp.web;

import com.github.romanzin87.votingapp.error.AppException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> conflict(WebRequest request, DataIntegrityViolationException ex) {
        ...
        return createResponseEntity(getDefaultBody(request, ErrorAttributeOptions.defaults(), EXCEPTION_DUPLICATE_RESTAURANT), HttpStatus.UNPROCESSABLE_ENTITY);
    }
